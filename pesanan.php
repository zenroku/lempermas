    ...
    <section class="tambah" style="margin-bottom: 200px">
        <div class="container">
            <div class="col m-5 text-center">
                <h1 class="text-success">Pesanan Masuk</h1>
                <hr>
            </div>
            ...
            <table class="table table-bordered text-center">
                ...
                <?php while($pecah = $ambil->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td><a href="detailp.php?id=<?= $pecah['id_pembelian']; ?>" class="btn btn-primary">Detail</a>
                        <a href="proses.php?id=<?= $pecah['id_pembelian']; ?>" class="btn btn-success">Proses</a>
                        </td>
                    </tr>
                <?php $nomor++; ?>
                <?php } ?>
