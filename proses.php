    ...
    <section class="tambah" style="margin-bottom: 200px">
        <div class="container">
            <div class="col m-5 text-center">
                <h1 class="text-success">Update Status Pemesanan</h1>
                <hr>
            </div>
            <?php
            ...
            <form method="post">
                <div class="form-group">
                    <div class="col-md-5 form-group">
                        <label class="font-weight-bold">Update Status Pesanan</label>
                        <select name="status" class="col-md-5 form-control">
            ...
            if (isset($_POST['proses'])) {
                ...
                $status = $_POST['status'];
                $conn->query("UPDATE pembelian SET status_pembelian = '$status' WHERE id_pembelian = '$id_pembelian'");
                
                echo "<script>alert('Status Telah Terupdate !');</script>";
